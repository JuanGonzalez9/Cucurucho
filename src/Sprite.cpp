...
Sprite::Sprite() {
	...
	loginfo("Se cargaron los frames para el personaje caminando");
	cargarFramesSaltando();
	loginfo("Se cargaron los frames para el personaje saltando");
	cargarFramesDisparando();
	loginfo("Se cargaron los frames para el personaje disparando");
	cargarFramesDisparandoCaminando();
	loginfo("Se cargaron los frames para el personaje disparando mientras camina");
	cargarFramesDisparandoArribaCaminando();
	loginfo("Se cargaron los frames para el personaje disparando para arriba mientras camina");
	cargarFramesDisparandoAbajoCaminando();
	loginfo("Se cargaron los frames para el personaje disparando para abajo mientras camina");
	cargarFramesAgachado();
	loginfo("Se cargaron los frames para el personaje agachado");
